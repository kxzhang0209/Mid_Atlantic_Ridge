...
!=======================================================
  ...
  contains
    ...
    subroutine predotite_solidus_Katz_Spiegelman2003(pressure, temperature)
      implicit none
      real, parameter :: A3 = -5.1 ! C/GPa^2
      real, parameter :: A2 = 132.9 ! C/GPa
      real, parameter :: A1 = 1085.7 ! C
      
      real :: pressure, temperature

      temperature = A1 + A2 * pressure + A3 * pressure**2
      return
    end subroutine
    ...
    subroutine unrelaxed_shear_modulus(temperature,pressure,shear_modulus)
      ...
      ! calculate unrelaxed modulus at given temperature and pressure
      shear_modulus = Gur + temperature * dGudT + pressure * dGudP ! 5.11
...
!!!Question: viscosity? qinv?vs?
    ...
    subroutine yamauchi_takei_2016(z,T,seisfreq,Vs,Q,Tm,eta,J1,J2,Q_b,Vs_b)
      ...
      !call predotite_solidus_Katz_Spiegelman2003(P_gpa, Tm)
